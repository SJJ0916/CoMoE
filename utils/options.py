...
def get_args():
    ...
    parser.add_argument("--moe_lr_factor", type=float, default=10.)
    parser.add_argument("--transformer_lr_factor", type=float, default=2.)
    ...
    parser.add_argument("--cnum", type=int, default=9)
    ...
    parser.add_argument("--moe_heads", type=int, default=8)
    parser.add_argument("--aux_factor", type=float, default=1.0)
