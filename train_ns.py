...
from model import build_model, build_model_ns
...
if __name__ == '__main__':
    ...
    args.output_dir = op.join(args.output_dir, args.dataset_name,
                              f'{args.loss_names}_ne{args.num_experts}_top{args.topk}_layer{args.moe_layers}_lr{args.lr}_ns')
    ...
    model = build_model_ns(args, num_classes)
